...
# Question 2
  ...
  puts "Combien il y a de handle avec numéro ?"
  count = 0
...
puts journalist.select {|e| e =~ /^@[A-Z]/ }.size
...
puts journalist.sort_by {|journalist| journalist.downcase}

#Question 8

puts "Quels sont les 50 handles les plus courts de cet array ?"
puts journalist.min {|a,b| a.size <=> b.size }
